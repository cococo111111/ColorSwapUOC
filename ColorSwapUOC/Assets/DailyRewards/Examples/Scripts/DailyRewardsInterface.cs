...
namespace NiobiumStudios
{
    ...
    public class DailyRewardsInterface : MonoBehaviour
    {
        ...
        public void UpdateUI()
        {
            ...
            {
                SnapToReward();
                textTimeDue.text = textCanClaim.text;
            }
        ...
        private void CheckTimeDifference ()
        {
            if (!readyToClaim)
            {
                ...
                textTimeDue.text = textTimeDue1.text +"  "+ formattedTs +"  "+ textTimeDue2.text;
            }
        }
        ...
        private void OnClaimPrize(int day)
        {
            ...
            if (rewardQt > 0)
            {
                textReward.text = textReward1.text + reward.reward +" " + unit;
            }
            else
            {
                textReward.text = textReward1.text + " " +unit;
            }
        }
