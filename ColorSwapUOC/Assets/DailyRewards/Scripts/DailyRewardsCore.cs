...
namespace NiobiumStudios
{
    ...
    public abstract class DailyRewardsCore<T> : MonoBehaviour where T : DailyRewardsCore<T>
    {
        ...
        public string worldClockUrl = "http://worldtimeapi.org/api/timezone/America/New_York";  // The World Clock JSON API
        public string worldClockFMT = "yyyy-MM-dd'T'HH:mm:ss.ffffffzzz";  // World Clock Format
