...
namespace EasyMobile.Editor
{
    ...
    internal partial class EM_SettingsEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorGUILayout.BeginVertical(EM_GUIStyleManager.FullWidthBottomSeparatorBox);
                if (GUILayout.Button(new GUIContent("Back To Home", EM_GUIStyleManager.HomeIcon), EM_GUIStyleManager.GetCustomStyle("Module Back Button Text")))
                {
