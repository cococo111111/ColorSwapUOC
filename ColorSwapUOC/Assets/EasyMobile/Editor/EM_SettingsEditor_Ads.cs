...
namespace EasyMobile.Editor
{
    ...
    internal partial class EM_SettingsEditor
    {
        ...
        const string UnityAdsDefaultPlacementsMsg = "These placement IDs match the default placement IDs that Unity Ads generated automatically. " +
            ...
            DrawUppercaseSection("UNITY_ADS_SETUP_FOLDOUT_KEY", "UNITY ADS", () =>
                {
                    ...
                    EditorGUI.indentLevel++;
                    EditorGUI.BeginDisabledGroup(true);     // not allowing modifying default UnityAds default placement IDs
